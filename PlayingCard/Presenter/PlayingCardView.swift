...
//  PlayingCard
//
//  Created by Victor Smirnov on 04.02.2020.
...
class PlayingCardView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if isFaceUp {
            ...
            guard let backCardFace = UIImage(named: "cardback", in: Bundle(for: self.classForCoder), compatibleWith: traitCollection) else { return }
            backCardFace.draw(in: bounds)
        }
